package org.icroco.boot.javafx.text;
...
public class ScenarioDemo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Scene scene = new Scene(new StackPane(new VirtualizedScrollPane<>(codeArea)), 600,
				400);
